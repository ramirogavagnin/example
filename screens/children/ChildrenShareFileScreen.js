...
function ChildrenShareFileScreen(props) {
    ...
    const { navigation, currentChildrenRecord } = props
            ...
            <Layout style={styles.contentContainer}>
                <View style={[row, flexEnd, { marginRight: wp(-3) }]}>
                    <Entypo
                        ...
                        color={greyIcon}
                        onPress={() =>
                            navigation.navigate(routes.childrenShareHistory)
                        }
                    />
                </View>
                <View style={[center]}>
...
ChildrenShareFileScreen.navigationOptions = props => ({
    headerBackground: (
        <LinearGradient
...
export default connect(mapStateToProps, null)(ChildrenShareFileScreen)
